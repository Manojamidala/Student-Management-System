...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		btnNewButton.setFont(new Font("TimesNewRoman", Font.BOLD, 18));
		...
		btnNewButton_1.setFont(new Font("TimesNewRoman", Font.BOLD, 18));
		...
		btnNewButton_2.setFont(new Font("TimesNewRoman", Font.BOLD, 18));
		...
		btnNewButton_3.setFont(new Font("TimesNewRoman", Font.BOLD, 18));
		...
		btnNewButton_4.setFont(new Font("TimesNewRoman", Font.BOLD, 18));
		btnNewButton_4.setBounds(32, 348, 287, 47);
		desktopPane.add(btnNewButton_4);
		
		JLabel lblNewLabel = new JLabel("Choose an Option Below");
		lblNewLabel.setForeground(Color.BLACK);
		lblNewLabel.setBounds(93, 17, 220, 27);
		desktopPane_1.add(lblNewLabel);
		lblNewLabel.setFont(new Font("TimesNewRoman", Font.BOLD, 22));
